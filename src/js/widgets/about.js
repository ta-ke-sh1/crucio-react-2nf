      ...
      <>
         <div id="about" className="m-container">
            <div className="content" style={{width: "80%"}}>
               <h1 style={{fontSize: "65px", letterSpacing:"10px"}}>WELCOME TO <span style={{"color": "#AD00FF"}}>CRUCIO</span></h1>
               <br />
               <h2 style={{fontSize: "45px", letterSpacing:"15px"}}>WE CREATE AWESOME WEBSITES</h2>
               <br />
               <p style={{"color": "black", fontSize:"20px"}}>Lorem ipsum dolor sit amet, consectetur adipisci elit, sed eiusmod tempor incidunt
