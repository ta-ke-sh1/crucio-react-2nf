...
export default function Service(){
   return(
         ...
         <div className="content">
            ...
            <div className="services-grid">
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-pc-display-horizontal"
                     viewBox="0 0 16 16">
                     <path
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-collection-fill"
                     viewBox="0 0 16 16">
                     <path
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-grid-3x3-gap"
                     viewBox="0 0 16 16">
                     <path
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-palette"
                     viewBox="0 0 16 16">
                     <path
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-camera-fill"
                     viewBox="0 0 16 16">
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" class="bi bi-camera-video-fill"
                     viewBox="0 0 16 16">
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-graph-up-arrow"
                     viewBox="0 0 16 16">
                     <path fill-rule="evenodd"
               ...
               <div className="grid-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" className="bi bi-person-fill"
                     viewBox="0 0 16 16">
      ...
      <div id="get-started" className="f-container purple-bg">
         <div className="content">
            <h1 style={{"color": "white", "letter-spacing": "8px"}}>WE CREATE <span>AWESOME</span> PROJECTS</h1>
         </div>
